...
const transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
    user: '22je0728@iitism.ac.in', // your email@gmail.com
    pass: 'Praveenkumar@1234' // your gmail password
  }
});
...
app.post('/add_contact', (req, res) => {
  ...
  const mailOptions = {
    from: '22je0728@iitism.ac.in', // email@gmail.com
    to: 'praveenkumar155670@gmail.com', // admin@gmail.com
